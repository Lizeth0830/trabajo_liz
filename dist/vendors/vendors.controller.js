...
const vendors_service_service_1 = require("./vendors.service.service");
const common_1 = require("@nestjs/common");
let VendorsController = class VendorsController {
    VendorsServiceService;
    constructor(VendorsServiceService) {
        this.VendorsServiceService = VendorsServiceService;
    }
    create(body) {
